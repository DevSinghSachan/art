...
from megatron.data.pretokenized_evidence import get_pretokenized_evidence_dataset, get_open_retrieval_batch
...
class IndexBuilder(object):
    ...
    def __init__(self, call_load_attributes_func=True, custom_load_path=None, key_list=None):
        ...
        self.dataset = get_pretokenized_evidence_dataset()
